      ...
      <div className="container mx-auto">
        <div className="text-center">
          ...
          <p className="text-white/70">
            Be the first to get the latest news about trend, promotions and
            munch more!
          </p>
        </div>
        {/* form */}
        ...
        {/* links */}
        <div
          className="text-base text-white/60 flex 
        gap-x-6 capitalize max-w-max mx-auto mb-9"
        >
      ...
      <div className="py-10 border-t border-t-white/10">
        <div className="container mx-auto">
          <div className="text-center text-sm text-white/60">
            Copyright &copy; Protoland 2023 rigths reserved.
          </div>
        </div>
      </div>
    </footer>
